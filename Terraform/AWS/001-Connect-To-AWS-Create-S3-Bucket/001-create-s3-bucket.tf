...
For S3 - "my-terraform-bucket" is the resource name for the S3 bucket in terraform
Actual name of the bucket will be - samarth-terraform-bucket

Note: This is a non-versioned and private bucket
